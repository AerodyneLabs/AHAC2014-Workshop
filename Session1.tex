...
\begin{frame}[fragile]
	...
	\lstinputlisting[language=C++,caption=main.cpp]{snippets/first_program/1.cpp}
\end{frame}

\begin{frame}[fragile]
	\frametitle{Breaking Down main.cpp}
	\lstinputlisting[language=C++, firstline=1, lastline=1, firstnumber=1]{snippets/first_program/1.cpp}
	...
	\lstinputlisting[language=C++, firstline=3, lastline=3, firstnumber=3]{snippets/first_program/1.cpp}
...
\begin{frame}[fragile]
	\frametitle{Breaking Down main.cpp}
	\lstinputlisting[language=C++, firstline=5, lastline=5, firstnumber=5]{snippets/first_program/1.cpp}
	...
	\lstinputlisting[language=C++, firstline=6, lastline=6, firstnumber=6]{snippets/first_program/1.cpp}
...
\begin{frame}[fragile]
	\frametitle{Breaking Down main.cpp}
	\lstinputlisting[language=C++, firstline=7, lastline=10, firstnumber=7]{snippets/first_program/1.cpp}
