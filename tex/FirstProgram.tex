...
\begin{frame}
	...
	\begin{columns}[c]
		\begin{column}{0.5\textwidth}
			\lstinputlisting[title=main.cpp]{code/first_program/1.cpp}
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
...
\begin{frame}
	...
	\begin{columns}[c]
		\begin{column}{0.55\textwidth}
			\lstinputlisting[title=main.cpp]{code/first_program/2.cpp}
		\end{column}
...
\begin{frame}
	...
	\begin{columns}[c]
		\begin{column}{0.6\textwidth}
			\lstinputlisting[title=main.cpp]{code/first_program/3.cpp}
		\end{column}
